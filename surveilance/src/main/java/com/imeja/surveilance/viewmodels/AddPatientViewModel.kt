...
import com.imeja.surveilance.AddPatientFragment
...
class AddPatientViewModel(application: Application, private val state: SavedStateHandle) :
    ...
    private var fhirEngine: FhirEngine =
        FhirApplication.Companion.fhirEngine(application.applicationContext)
    ...
    private fun fetchQuestionnaireJson(): String {
        ...
        _questionnaireJson =
            getApplication<Application>()
                .readFileFromAssets(state[AddPatientFragment.Companion.QUESTIONNAIRE_FILE_PATH_KEY]!!)
